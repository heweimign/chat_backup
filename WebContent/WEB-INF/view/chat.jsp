    ...
    <script type="text/javascript">  
        ...
        function connect() {  
            ...
            if ('WebSocket' in window) {  
                ws= new WebSocket("ws://172.17.16.68:8080/maven-ssm-chat/websck");  
                console.log("ws://172.17.16.68:8080/maven-ssm-chat/websck");  
            }else {  
                ws = new SockJS("http://172.17.16.68:8080/maven-ssm-chat/sockjs/websck");  
                console.log("http://172.17.16.68:8080/maven-ssm-chat/sockjs/websck");  
            }  
